...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private boolean checkSelfPermissions() {
        return checkSelfPermission(Manifest.permission.READ_PHONE_STATE, ConstantApp.PERMISSION_REQ_ID_READ_PHONE_STATE) &&
                checkSelfPermission(Manifest.permission.SEND_SMS, ConstantApp.PERMISSION_REQ_ID_SEND_SMS) &&
                checkSelfPermission(Manifest.permission.READ_CONTACTS, ConstantApp.PERMISSION_REQ_ID_READ_CONTACTS) &&
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            ...
            case ConstantApp.PERMISSION_REQ_ID_SEND_SMS: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    checkSelfPermission(Manifest.permission.READ_CONTACTS, ConstantApp.PERMISSION_REQ_ID_READ_CONTACTS);
                } else {
            ...
            case ConstantApp.PERMISSION_REQ_ID_READ_CONTACTS: {
                if (grantResults.length > 0
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    checkSelfPermission(Manifest.permission.RECORD_AUDIO, ConstantApp.PERMISSION_REQ_ID_RECORD_AUDIO);
                } else {
